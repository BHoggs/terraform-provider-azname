...
- `vm-prod-eus-001` (Parent Virtual Machine)
- `vm-prod-eus-001-nic-mgmt` (child network interface attached to a virtual machine)
- `stprodeus123` (Parent Storage Account)
- `stprodeus123-pe-blob` (child private endpoint for a storage account)
